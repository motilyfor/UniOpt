...
static INLINE void opt_cpy_256(void* dst, const void* src)
{
    ...
    uint8x16_t v2 = vld1q_u8((const uint8_t*)src + 32);
    uint8x16_t v3 = vld1q_u8((const uint8_t*)src + 48);
    uint8x16_t v4 = vld1q_u8((const uint8_t*)src + 64);
    uint8x16_t v5 = vld1q_u8((const uint8_t*)src + 80);
    uint8x16_t v6 = vld1q_u8((const uint8_t*)src + 96);
    uint8x16_t v7 = vld1q_u8((const uint8_t*)src + 112);
    vst1q_u8((uint8_t*)dst + 0, v0);
    vst1q_u8((uint8_t*)dst + 16, v1);
    vst1q_u8((uint8_t*)dst + 32, v2);
    vst1q_u8((uint8_t*)dst + 48, v3);
    vst1q_u8((uint8_t*)dst + 64, v4);
    vst1q_u8((uint8_t*)dst + 80, v5);
    vst1q_u8((uint8_t*)dst + 96, v6);
    vst1q_u8((uint8_t*)dst + 112, v7);
#endif
}
...
//---------------------------------------------------------------------
static INLINE void* opt_cpy_small(void* dst, const void* src, size_t size)
{
